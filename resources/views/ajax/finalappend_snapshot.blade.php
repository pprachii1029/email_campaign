<tr>
    <th scope="row">
        <input type="text" class="form-control order" name="order_snap[]" style="border-radius: 5px !important;border: 1px solid gray !important;background-color: white;" onchange="change_order(this)" required value="{{ $order }}">
    </th>
    <td> 
