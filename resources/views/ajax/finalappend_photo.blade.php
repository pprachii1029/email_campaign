<tr>
    <th style="width:10%" scope="row">
        <input type="text" class="form-control order" name="order_photo[]" style="border-radius: 5px !important;border: 1px solid gray !important;background-color: white;" onchange="change_order(this)" required value="{{ $order }}">
    </th>
