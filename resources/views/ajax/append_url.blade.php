<tr>
    <th style="width:10%" scope="row">
        <input type="text" class="form-control order" name="order_url[]" style="border-radius: 5px !important;border: 1px solid gray !important;background-color: white;"  required value="{{ $order }}">
    </th>
